...
| NuGimli Cascade | reviewed and measured | Fixed loop bounds and public schedules; no secret-indexed lookup or secret-dependent branch. Fixed/random first- and second-order Welch timing tests passed for 512/1024/2048 encrypt, decrypt, and tagged derivation paths |
