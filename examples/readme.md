...
See [evaluation/tests/](../evaluation/tests/) for KAT (Known-Answer Test) vectors and [evaluation/benchmarks/bench_custom_crypto_table.nim](../evaluation/benchmarks/bench_custom_crypto_table.nim) for benchmark scripts.
