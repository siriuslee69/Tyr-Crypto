...
proc poly1305MacBatchImpl[T: SimdU64](
  ...
  defer:
    secureClearPod(cVec)
    secureClearPod(r0Vals)
    secureClearPod(r1Vals)
    secureClearPod(r2Vals)
    secureClearPod(r3Vals)
    secureClearPod(r4Vals)
    secureClearPod(s1Vals)
    secureClearPod(s2Vals)
    secureClearPod(s3Vals)
    secureClearPod(s4Vals)
    secureClearPod(pad0Vals)
    secureClearPod(pad1Vals)
    secureClearPod(pad2Vals)
    secureClearPod(pad3Vals)
    secureClearPod(h0Vals)
    secureClearPod(h1Vals)
    secureClearPod(h2Vals)
    secureClearPod(h3Vals)
    secureClearPod(h4Vals)
    secureClearPod(d0Vals)
    secureClearPod(d1Vals)
    secureClearPod(d2Vals)
    secureClearPod(d3Vals)
    secureClearPod(d4Vals)
    secureClearPod(blk)
    secureClearPod(h0)
    secureClearPod(h1)
    secureClearPod(h2)
