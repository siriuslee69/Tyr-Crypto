...
const algorithmLayouts*: array[AlgorithmKind, AlgorithmLayout] = [
  ...
  buildLayout(akNtru0TyrSend, okKemSend, 32, kkPublicKey -> 699),
  buildLayout(akNtru0TyrOpen, okKemOpen, 32, kkSecretKey -> 935),
  buildLayout(akNtru1TyrSend, okKemSend, 32, kkPublicKey -> 930),
  buildLayout(akNtru1TyrOpen, okKemOpen, 32, kkSecretKey -> 1234),
  buildLayout(akNtru2TyrSend, okKemSend, 32, kkPublicKey -> 1230),
  buildLayout(akNtru2TyrOpen, okKemOpen, 32, kkSecretKey -> 1590),
  buildLayout(akNtruHrss0TyrSend, okKemSend, 32, kkPublicKey -> 1138),
  buildLayout(akNtruHrss0TyrOpen, okKemOpen, 32, kkSecretKey -> 1450),
  buildLayout(akSaber0TyrSend, okKemSend, 32, kkPublicKey -> 672),
  buildLayout(akSaber0TyrOpen, okKemOpen, 32, kkSecretKey -> 1568),
  buildLayout(akSaber1TyrSend, okKemSend, 32, kkPublicKey -> 992),
  buildLayout(akSaber1TyrOpen, okKemOpen, 32, kkSecretKey -> 2304),
  buildLayout(akSaber2TyrSend, okKemSend, 32, kkPublicKey -> 1312),
  buildLayout(akSaber2TyrOpen, okKemOpen, 32, kkSecretKey -> 3040),
  buildLayout(akHqc0TyrSend, okKemSend, 32, kkPublicKey -> 2241),
  buildLayout(akHqc0TyrOpen, okKemOpen, 32, kkSecretKey -> 2321),
  buildLayout(akHqc1TyrSend, okKemSend, 32, kkPublicKey -> 4514),
  buildLayout(akHqc1TyrOpen, okKemOpen, 32, kkSecretKey -> 4602),
  buildLayout(akHqc2TyrSend, okKemSend, 32, kkPublicKey -> 7237),
  buildLayout(akHqc2TyrOpen, okKemOpen, 32, kkSecretKey -> 7333),
