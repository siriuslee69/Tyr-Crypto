...
when defined(avx2):
  ...
  proc vset1x(x: uint32): Vec8 =
    result = mm256_set1_epi32(cast[int32](x))

  proc vset8(a0, a1, a2, a3, a4, a5, a6, a7: uint32): Vec8 =
    result = mm256_set_epi32(cast[int32](a7), cast[int32](a6),
      cast[int32](a5), cast[int32](a4), cast[int32](a3), cast[int32](a2),
      cast[int32](a1), cast[int32](a0))
