...
proc testsRoot(): string {.role: {helper}.} =
  ## Returns the `evaluation/tests/` directory. Every result file goes somewhere
  ## under here, never the repository root - run output is not source and
  ## should not sit next to it.
  result = testsRootFrom(currentSourcePath())

proc defaultResultsDirectory*(): string {.role: {helper}.} =
  ## Returns the default persistent UI result directory, `evaluation/tests/testResults`.
...
proc buildCatalog*(): seq[TestCatalogEntry] {.role: {truthBuilder}.} =
  ...
  addEntry(result, "foundation", "Core vectors and KDF", "symmetric",
    ["functional", "vectors", "edge"], ["evaluation/tests/test_custom_crypto.nim"])
  addEntry(result, "sha256", "SHA-256 and TLS KDF", "hash",
    ["functional", "vectors", "edge"], ["evaluation/tests/test_tls_primitives.nim"])
  addEntry(result, "sha3", "SHA-3 / SHAKE", "hash",
    ["functional", "vectors", "simd", "edge"],
    ["evaluation/tests/test_sha3_custom.nim", "evaluation/tests/test_sha3_simd.nim"])
  addEntry(result, "blake3", "BLAKE3", "hash",
    ["functional", "vectors", "simd", "edge"],
    ["evaluation/tests/test_blake3_simd.nim", "evaluation/tests/test_blake3_stream.nim"])
  addEntry(result, "chacha", "ChaCha20 / XChaCha20", "symmetric",
    ["functional", "vectors", "simd", "edge"],
    ["evaluation/tests/test_xchacha20_simd.nim"])
  addEntry(result, "aes", "AES core and CTR", "symmetric",
    ["functional", "vectors", "simd", "edge"],
    ["evaluation/tests/test_aes_ctr.nim", "evaluation/tests/test_aes_gcm_compare.nim"])
  addEntry(result, "gimli", "Gimli permutation and sponge", "hash",
    ["functional", "vectors", "simd"],
    ["evaluation/tests/test_gimli_sse.nim", "evaluation/tests/test_gimli_vectors.nim"])
  addEntry(result, "poly1305", "Poly1305", "mac",
    ["functional", "vectors", "simd", "edge"],
    ["evaluation/tests/test_poly1305_custom.nim", "evaluation/tests/test_poly1305_simd.nim"])
  addEntry(result, "hmac", "Custom HMAC", "mac",
    ["functional", "vectors", "edge"], ["evaluation/tests/test_custom_hmac.nim"])
  addEntry(result, "argon2", "Argon2", "password",
    ["functional", "vectors", "simd", "edge"], ["evaluation/tests/test_argon2_simd.nim"])
  addEntry(result, "random", "Random entropy", "entropy",
    ["functional", "edge"], ["evaluation/tests/test_random_entropy.nim"])
  addEntry(result, "otp", "One-time passwords", "password",
    ["functional", "vectors", "edge"], ["evaluation/tests/test_otp.nim"])
  addEntry(result, "x25519", "X25519", "classical",
    ["functional", "vectors", "simd", "edge"],
    ["evaluation/tests/test_x25519_custom.nim", "evaluation/tests/test_x25519_simd.nim"])
  addEntry(result, "ed25519", "Ed25519", "classical",
    ["functional", "vectors", "edge"], ["evaluation/tests/test_ed25519_custom.nim"])
  addEntry(result, "kyber", "Kyber-768 / 1024", "pq-kem",
    ["functional", "vectors", "kat", "simd", "edge"],
    ["evaluation/tests/test_kyber_tyr.nim", "evaluation/tests/test_kyber_kat.nim"])
  addEntry(result, "frodo", "FrodoKEM", "pq-kem",
    ["functional", "vectors", "kat", "simd", "edge"],
    ["evaluation/tests/test_frodo_tyr.nim", "evaluation/tests/test_frodo_kat.nim"])
  addEntry(result, "bike", "BIKE", "pq-kem",
    ["functional", "vectors", "kat", "edge"],
    ["evaluation/tests/test_bike_tyr.nim", "evaluation/tests/test_bike_kat.nim"])
  addEntry(result, "ntru", "NTRU", "pq-kem",
    ["functional", "vectors", "kat", "simd", "edge"],
    ["evaluation/tests/test_ntru_tyr.nim"])
  addEntry(result, "saber", "SABER", "pq-kem",
    ["functional", "vectors", "kat", "simd", "edge"],
    ["evaluation/tests/test_saber_tyr.nim"])
  addEntry(result, "mceliece", "Classic McEliece", "pq-kem",
    ["functional", "vectors", "edge"],
    ["evaluation/tests/test_mceliece_tyr.nim", "evaluation/tests/test_ct_verify.nim"])
  addEntry(result, "dilithium", "ML-DSA / Dilithium", "pq-signature",
    ["functional", "vectors", "kat", "simd", "edge"],
    ["evaluation/tests/test_dilithium_tyr.nim", "evaluation/tests/test_dilithium_kat.nim",
      "evaluation/tests/test_ct_verify.nim"])
  addEntry(result, "falcon512", "Falcon-512", "pq-signature",
    ["functional", "vectors", "edge"], ["evaluation/tests/test_falcon_tyr.nim"],
  ...
  addEntry(result, "sphincs", "SPHINCS+", "pq-signature",
    ["functional", "vectors", "kat", "edge"],
    ["evaluation/tests/test_sphincs_tyr.nim", "evaluation/tests/test_sphincs_kat.nim",
      "evaluation/tests/test_ct_verify.nim"])
  addEntry(result, "composite", "Composite cipher suites", "composite",
    ["functional", "edge"],
    ["evaluation/tests/test_aes_gimli.nim", "evaluation/tests/test_xchacha20_gimli.nim",
      "evaluation/tests/test_xchacha20_aes_gimli.nim",
      "evaluation/tests/test_xchacha20_aes_gimli_poly1305.nim"])
  addEntry(result, "wrapper", "Wrapper authentication", "api",
    ["functional", "vectors", "edge"], ["evaluation/tests/test_wrapper.nim"])
  addEntry(result, "hybrid", "Hybrid KEX duo and triple", "api",
    ["functional", "edge"],
    ["evaluation/tests/test_hybrid_kex_duo.nim", "evaluation/tests/test_hybrid_kex_triple.nim"])
  addEntry(result, "public-api", "Public API surfaces", "api",
    ["functional", "edge"],
    ["evaluation/tests/test_quick_api.nim", "evaluation/tests/test_primitives_api.nim",
      "evaluation/tests/test_public_api_surface.nim", "evaluation/tests/test_signatures.nim"])
  addEntry(result, "wasm-bridge", "WASM JSON bridge", "interop",
    ["functional", "vectors", "edge"], ["evaluation/tests/test_wasm_bridge.nim"])
  addEntry(result, "bench-bytes", "Byte primitive benchmarks", "benchmark",
    ["benchmark", "symmetric", "hash", "mac"],
    ["evaluation/benchmarks/bench_custom_crypto_table.nim"], tckCustomBench, "bytes")
  addEntry(result, "bench-kem", "KEM benchmarks", "benchmark",
    ["benchmark", "pq-kem"], ["evaluation/benchmarks/bench_custom_crypto_table.nim"],
    tckCustomBench, "kem")
  addEntry(result, "bench-signature", "Signature benchmarks", "benchmark",
    ["benchmark", "pq-signature"], ["evaluation/benchmarks/bench_custom_crypto_table.nim"],
...
proc expandDirectory(path: string): string {.role: {helper}.} =
  ...
  if not expanded.isAbsolute():
    ## Relative entries resolve under `evaluation/tests/`, not the repository root,
