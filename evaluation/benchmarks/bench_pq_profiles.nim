...
proc suiteTestPath(a: BenchSuite): string =
  ...
  case a
  of bsPq:
    result = "evaluation/benchmarks/bench_sigma_pq.nim"
  of bsKyber:
    result = "evaluation/benchmarks/bench_sigma_kyber_only.nim"
  of bsFrodo:
    result = "evaluation/benchmarks/bench_sigma_frodo_profile.nim"
  of bsDilithium:
    result = "evaluation/benchmarks/bench_sigma_dilithium.nim"
  of bsFalcon512, bsFalcon1024:
    result = "evaluation/benchmarks/bench_sigma_falcon.nim"
