  ...
  when not defined(release):
    ...
    test "pure-nim SPHINCS roundtrip works":
      var
        ...
        p = custom_sphincs.sphincsParamsTable[
          custom_sphincs.sphincsShake128fSimple]
        malformedSig, malformedPk: seq[byte]
        i: int = 0
      ...
      check not custom_sphincs.sphincsTyrVerify(
        custom_sphincs.sphincsShake128fSimple, msg, malformedSig, kp.publicKey)
      malformedSig = sig
      ...
      malformedPk = kp.publicKey
      malformedPk[^1] = malformedPk[^1] xor 1'u8
      check not custom_sphincs.sphincsTyrVerify(
        custom_sphincs.sphincsShake128fSimple, msg, malformedSig, kp.publicKey)
      check not custom_sphincs.sphincsTyrVerify(
        custom_sphincs.sphincsShake128fSimple, msg, sig, malformedPk)
