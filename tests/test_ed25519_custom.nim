...
suite "custom ed25519":
  ...
  test "signing rejects an inconsistent secret-key public half":
    var
      seed = hexToBytes("000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f")
      kp = customEd25519.ed25519TyrKeypairFromSeed(seed)
    kp.secretKey[63] = kp.secretKey[63] xor 1'u8
    expect ValueError:
      discard customEd25519.ed25519TyrSign(@[], kp.secretKey)
